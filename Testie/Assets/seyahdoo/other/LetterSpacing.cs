/**
* This is written for adjust letter spacing in unity UI
* See my reusable unity codes at:  https://github.com/seyahdoo/Unity-Code-Repo
* See my personal website at: http://seyahdoo.com
*
* 
* @author  Chris Underwood (Deeperbeige) 
* @version 1.0.0
* @authorwebsite http://deeperbeige.com/
* @originalrepo https://bitbucket.org/AcornGame/adjustable-character-spacing
*/
